...
const DEMOS = [
  { type: "员工用户", user: "employee", pass: "employee123", desc: "制度问答、可信引用与个人记忆", icon: "chat" as const },
  { type: "HR 管理员", user: "hr_admin", pass: "admin123", desc: "制度审核、冲突 HITL 与反馈闭环", icon: "building" as const },
  ...
  return (
    <div className={styles.wrap}>
      ...
      <section className={styles.story}>
        <div className={styles.wordmark}><span className={styles.seal}>文</span><span>HRAgents</span></div>
      ...
      <section className={styles.loginSide}>
        <form className={styles.card} onSubmit={submit}>
          <div className={styles.mobileBrand}><span className={styles.seal}>文</span> HRAgents</div>
