...
except ImportError:  # memory-mode development/tests should not require Mongo extras
...
class MongoDB:
    ...
    async def connect(self) -> None:
        ...
        if AsyncIOMotorClient is None:
            raise RuntimeError("storage_mode=mongo requires the optional 'motor' dependency")
    ...
    async def _ensure_indexes(self) -> None:
        ...
        indexes: dict[str, list[tuple[list[tuple[str, int]], dict]]] = {
            ...
            "policy_claims": [
                ([("doc_id", 1), ("claim_status", 1)], {}),
                ([("company_id", 1), ("dept_id", 1)], {}),
                ([("fingerprint", 1)], {"unique": True}),
            ],
            "policy_conflict_cases": [
                ([("company_id", 1), ("status", 1), ("created_at", -1)], {}),
                ([("left_doc_id", 1)], {}),
                ([("right_doc_id", 1)], {}),
            ],
            "job_profiles": [([("company_id", 1), ("role", 1)], {})],
            "candidate_profiles": [([("company_id", 1), ("created_at", -1)], {})],
            "interview_question_bank": [([("role", 1), ("status", 1)], {})],
        }
