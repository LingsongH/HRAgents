...
class Document(MongoModel):
    ...
    doc_type: str = "policy"
    version: str = ""
    status: str = "active"  # runtime: indexing|active|archived|deleted
    policy_state: str = "effective"  # business: draft|review|effective|deprecated|deleted
    policy_level: str = "company"  # law|group|company|department|team
...
class UserProfile(MongoModel):
    ...
    user_id: str = ""
    name: str = ""
    role: str = "employee"  # employee|hr|hr_admin|admin
    department: str = ""
    grade: str = ""
