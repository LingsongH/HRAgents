...
- 用户角色：employee（员工问答）/ hr、hr_admin（HR 业务）/ admin（平台治理）。
...
DEFAULT_USERS = [
    {"username": "employee", "password": "employee123", "name": "演示员工", "role": "employee", "dept_id": "dept_rd", "company_id": "default"},
    {"username": "hr_admin", "password": "admin123", "name": "HR 管理员", "role": "admin", "dept_id": "dept_hr", "company_id": "default"},
    {"username": "admin", "password": "admin123", "name": "平台管理员", "role": "admin", "dept_id": "", "company_id": "default"},
]
...
class AuthService:
    ...
    async def seed_users(self) -> None:
        ...
        logger.warning("已创建演示账号（employee/employee123, hr_admin/admin123, admin/admin123）。生产环境请设置 SEED_DEMO_USERS=false 并删除这些账号。")
    ...
    def _to_user(u: dict[str, Any]) -> dict[str, Any]:
        return {
            ...
            "company_id": u.get("company_id", "default"),
