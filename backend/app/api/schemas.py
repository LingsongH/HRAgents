...
class DocumentStatusUpdate(BaseModel):
    status: str = Field(..., description="runtime status: draft | review | active | archived | deleted")
...
class OrganizationMemoryCreate(BaseModel):
    ...
    access_scope: list[str] = Field(default_factory=lambda: ["employee", "hr", "hr_admin", "admin"])
